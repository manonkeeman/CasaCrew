  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-4xl px-6 py-24 text-center">
        <h1 className="text-5xl font-extrabold tracking-tight text-stone-900">Contact</h1>
        <p className="mx-auto mt-4 max-w-xl text-xl text-stone-500">
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-5">
            ...
            <div className="md:col-span-2">
              ...
              <h2 className="mt-4 font-semibold text-stone-900">Direct contact</h2>
