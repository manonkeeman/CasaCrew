...
import com.casacrew.dto.EmergencyContactUpdateDTO;
...
public class EmergencyContactController {
    ...
    public ResponseEntity<EmergencyContact> updatePhoneNumber(@PathVariable Long id, @Valid @RequestBody EmergencyContactUpdateDTO body) {
